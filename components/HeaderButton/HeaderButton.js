...
const HeaderButton = ({ leftIconName = undefined, onPress = () => { }, rightIconName = undefined, route = '', routeParams, text = '', }) => {
    ...
    return (<Pressable onPress={handlePress} style={pressableStyle}>
      {LeftIcon}
