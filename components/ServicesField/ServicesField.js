...
const ServicesField = (props) => {
    ...
    const goToSelectServices = React.useCallback(() => navigate(Route.SELECT_SERVICES, { entry, services }), [entry, navigate, services]);
    ...
    return (<Pressable onPress={goToSelectServices} style={wrapperStyle}>
...
//# sourceMappingURL=ServicesField.js.map